...
public class SpawnMgr
{
	...
	private static void VikingClick(int phase, int beats)
	{
		...
		case 5:
			if (beats / 8 >= 60)
			{
				// Finale swarm: this tail end of OUTTRO used to spawn nothing
				// at all. A steady wave of Blartards with an occasional Mega
				// Blartard mixed in, right up until the game-beaten trigger
